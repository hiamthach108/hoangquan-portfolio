  ...
  return (
    <div className="bg-white ">
      <div className="fluid-container">
        ...
        <div className="py-6 md:py-10 flex flex-col-reverse md:flex-row gap-6 md:gap-10">
          ...
          <div className="flex-1">
            <ul className="list-disc text-left text-base italic max-md:pl-2">
              ...
              <li>
                10th Grade Entrance Exam at Luong The Vinh High School for the gifted -
                Best Scorer 2022
              </li>
              ...
              <li>
                Course Certificate for Principles of Biochemistry by Harvard University
                2024
              </li>
            </ul>
          </div>
